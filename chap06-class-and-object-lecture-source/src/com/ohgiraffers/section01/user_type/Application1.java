...
public class Application1 {
    ...
    public static void main(String[] args) {
         ...
         * 2. 모든 회원 정보를 인자로 메소드 호출 시 값을 전달해야하면 너무 많은 값들을 인자로 전달해야해서 한 눈에 안들어온다.
         ...
         * 사용자 정의 자료형인 클래스를 이용하기 위해서는 new 연산자료 heap에 할당해야한다.
        ...
        System.out.println("member.age = " + member.age);
        System.out.println("member.gender = " + member.gender);
        //System.out.println("member.hobby = " + member.hobby); // 그냥 배열명으로 출력하면 주소값 나온다.
