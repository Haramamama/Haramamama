...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 수업 목표 : 객체지향 프로그래밍에 대해 이해하고 객체와 클래스를 설계하여 프로그래밍 할 수 있다.*/
        /*
         *  객체 지향 프로그래밍이란
        ...
        * 확보하기 위함이다. 유연성 확보는 여러곳에 적용할 수 있는 유일한 객체를 의미하며, 즉, 재사용성이 높아질 수 있다는
        ...
        * */
        ...
        /*
        * 시스템 요구사항
        * 1. 카레이서는 시동 걸기, 엑셀 밟기, 브레이크 밟기, 시동끄기를 할 수 있다.
        * 2.
/*
		 *  시스템 요구사항
        ...
        *  - 사용자, 카레이서, 자동차
        * 2. 객체간의 상호작용
        *  - 카레이서가 수신 할 수 있는 메시지(카레이서가 해야하는 일)
        *  (1) 시동을 걸어라
        *  (2) 엑셀을 밟아라
        *  (3) 브레이크를 밟아라
        *  (4) 시동을 꺼라
        *  - 자동차가 수신 할 수 있는 메시지(자동차가 해야 하는 일)
        *  (1) 시동을 걸어라
        *  (2) 앞으로 가라
        *  (3) 멈춰라
        *  (4) 시동을 꺼라
        ...
        * (1) 카레이서 클래스
        * - 속성 : 자동차
        * - 행위 : 시동걸기. 엑셀을 밟아라. 브레이크를 밟아라. 시동을 꺼라
        * (2) 자동차 클래스
        * - 속성 : 시동상태. 현재시속
        * - 메소드 : 시동걸기. 앞으로 가라. 멈춰라. 시동을 꺼라
        * */

        CarRacer carRacer = new CarRacer(); // 객체 생성
