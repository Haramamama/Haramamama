...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* 수업 목표: 접근제한자에 대해 이해하고 필드에 접근하지 못하게 강제화 할수 있다. */
        
        
        /*1. private 필드에 직접 접근하여 compile error를 발생 확인*/
        Monster monster1 = new Monster();
        /* monster1.Kinds = "피카츄";
        monster1.hp = 200;*/  // 에러 발생 프라이벳에 담겨있기 때문에.

        
        /*2. public 메소드를 이용하여 필드에 간접 접근*/
        monster1.setKinds("피카츄");
        monster1.setHp(200); // set은 넣어주는거고 get은 가져오는거.
