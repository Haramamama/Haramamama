...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업 목표: 배열의 사용방법을 익혀 배열을 사용할 수 있다. */
        /*
        * 배열의 사용방법
        * 1. 배열을 선언해준다.
        * 2. 배열을 할당해준다.
        * 3. 배열을 index 공간에 (방) 값 대입한다.
        * */
        ...
        * */
        ...
        /*
        * 배열을 할당할때는 반드시 배열의 크기를 지정해주어야한다.
        * */
        ...
        System.out.println("arr = " + arr2); // 출력값이 16진수 주소값(@)으로 나온다.
        System.out.println("carr2 = " + carr2); //출력값이 16진수 주소값(@)으로 나온다.
        ...
        * */
        ...
        darr= null;
        System.out.println("darr.length= " + darr.length );  // 주소값을 잃어버림.
    }
}
