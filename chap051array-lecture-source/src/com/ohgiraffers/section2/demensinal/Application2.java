...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        /* 수업 목표 : 2차원 정변배열을 선언 및 할당하여 사용할 수 있다. */
        /*1. 배열의 선언 및 할당 */
        /*정변 배열의 경우 각 인덱스별 배열을 따로 혈당할 수도 있지만 선언의 동시에 모든 배열을
        * 할당할 수 있다.
        * 자료형[][] 변수명 = new 자료형[할당할 배열의 갯수][할당할 배열의 길이]
        * */

        int[][] iarr = new int[3][5];  // 길이 5의 1ㅐ열을 3개 할당하고 그 주소를 묶어 관리하는 배열의 주소를 stack의 iarr에 저장한다.
