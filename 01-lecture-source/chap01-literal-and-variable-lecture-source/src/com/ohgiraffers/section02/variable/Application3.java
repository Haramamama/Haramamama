...
public class Application3 {
    ...
    public static void main(String[] args){
       ...
       * 또한, 규칙에 맞는 올바른 변수명을 짓는 것이 좋은 프로그래밍을 하는 첫 단추이다. */
        ...
        *  2-4. 한글로 변수명을 짓는 것은 가능하지만. 권장하지 않는다.(한글을 취급하는 다양한 방식들이 존재하기 때문데 에러를 유발시킬수 있다)
        ...
        *  2-8. boolean 형은 의문문으로 가급적 긍정형태로 네이밍 한다.  */
        ...
        /* 목차1-2. 예약어는 사용이 불가능하다.*/
        // int true = 1; // 예약어는 사용이 불가능하다.

        /* 목차1-3. 변수명은 대소문자를 구분한다. */
        ...
        /* 목차2-1 변수명의 길이제한은 없다. 하지만 적당히 하자. */
        int sfhjdhfosfusoifhsohfshfshfsodhfoshfpsdhfpsfhps;

        /* 목차2-2 변수명이 합성어로 이루어진 경우 첫 단어는 소문자 두 번째 시작 단어는 대문자로 시작한다 */
        ...
        /* 목차2-5. 변수 안에 저장된 값이 어떤 의미를 가지는지 정확하게 표현하도록 한다 */
        String s;
        String name; // 문자열 형태의 이름이 저장되겠구나! 의도파악

        /* 목차2-6 . 전형적인 변수 이름이 있다면 가급적 사용하도록 한다. */
        int sum = 8; //sum 더하기
        int max = 10;
        int min = 0;
        int count = 1; // count 개수

        /* 목차2-7. 명사형으로 작성할 수 있도록 한다. */
        String goHome; //가능하긴 하지만 가급적 명사형으로 짓는다.
        String home;

        /* 목차2-8 boolean 형은 의문문으로 가급적 긍정상태로 네이밍한다. */
