...
public class Application1 {
    ...
    public static void main(String[]args){
       ...
       // int salary; // 값이 없어도 변수 선언이 가능함
        ...
        System.out.println("1번의 고객에게 포인트몰 100포인트 지급하였습니다. ");
        System.out.println("2번의 고객에게 포인트몰 100포인트 지급하였습니다. ");
        System.out.println("3번의 고객에게 포인트몰 100포인트 지급하였습니다. ");
        System.out.println("4번의 고객에게 포인트몰 100포인트 지급하였습니다. ");
        System.out.println("5번의 고객에게 포인트몰 100포인트 지급하였습니다. ");
        System.out.println("6번의 고객에게 포인트몰 100포인트 지급하였습니다. ");
        System.out.println("7번의 고객에게 포인트몰 100포인트 지급하였습니다. ");
        System.out.println("8번의 고객에게 포인트몰 100포인트 지급하였습니다. ");
        System.out.println("9번의 고객에게 포인트몰 100포인트 지급하였습니다. ");
        System.out.println("10번의 고객에게 포인트몰 100포인트 지급하였습니다. ");

        int point=1000; //int는 숫자이기에 포인트라는 글자를 붙이지 않는다.
        ...
        System.out.println("=========변수에 지정된 값 변경 테스트==========");

        int sum = 0;

        sum = sum + 10; // 오른쪽의 값을 왼쪽에 넣어준다.
        System.out.println("sum에 10을 더하면 현재의 sum의 값은?: " + sum); // 계산식을 통해 값이 변한다. 변수이기에
