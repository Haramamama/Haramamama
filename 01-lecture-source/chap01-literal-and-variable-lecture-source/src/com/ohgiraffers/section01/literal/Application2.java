...
public class Application2 {
    ...
    public static void main(String[]args){
        ...
        System.out.println(123 - 23); // 연산자 사이에는 공백이 있어도 된다
        System.out.println(123 * 10); // 곱하기는 *
        System.out.println(123 / 10); // 나누기는 /
        System.out.println(5 % 2); // 나눗셈의 나머지를 구할때는 %

        /* 1-2 실수와 실수의 연산 */
        /* 실수끼리의 연산도 수학에서 사용하는 사칙연산에 나머지를 구하는 연산을 사용할 수 있다. */
        System.out.println("=========실수와 실수의 연산==========");
        System.out.println(1.23 + 1.23);
        System.out.println(1.23 - 0.23); // 실수와 실수이기에 1이 아닌 1.0으로 나오는거다.
        System.out.println(1.23 * 10.0);
        System.out.println(1.23 / 10.0);
        System.out.println(1.23 % 1.0); // 실수와 실수의 계산에서 약간의 오차가 생긴다.

        /* 1-3 정수와 실수의 연산 */
        /* 정수와 실수의 연산도 수학에서 사용하는 사칙연산에 나머지를 구하는 연산을 사용할 수 있다 */
        /* 정수와 실수의 연산의 결과는 항상 실수만 나온다 */
        System.out.println("=========정수와 실수의 연산==========");
        System.out.println(123 + 1.0);
        System.out.println(123 - 1.0);
        System.out.println(123 * 10.0);
        System.out.println(123 / 0.7); // 정수와 실수의 연산에는 나머지가 다 나온다.
        System.out.println(123 % 0.7); // 약간의 오차가 생긴다.
        ...
        * */
        ...
        // System.out.println(true * false); // 에러 발생
        // System.out.println(true / false); // 에러 발생
        // System.out.println(true % false); // 에러 발생  // boolean-논리
        ...
        /* 4-3 논리값과 실수의 연산*/
        /* 논리값과 실수(double)의 연산은 모든 연산자 사용이 불가능하다. */
        ...
        /* 이유: 문자는 내부적으로 숫자취급을 하기 때문에 결국 논리값과 숫자의 연산과 동일하다 */
        ...
        /* 이유: 위에서 테스트해본 문자열 합치기가 되는 원리와 동일하다 */
