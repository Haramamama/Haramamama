...
public class Application1 {
    ...
    public static void main(String[]args){
        ...
        // System.out.println('ab'); // 두개 이상은 문자로 취급하지 않기에 에러가 발생한다.
        // System.out.println(''); // 아무 문자도 기록되지 않는 경우 에러가 발생한다.
        System.out.println('1'); // 숫자값이지만 (원래 숫자에는 따옴표가 붙지 않는다) 홀따옴표 감싸져있는 경우 문자 1로 판단한다.
        System.out.println('남');

        /* 3. 문자열 형태의 값 출력 */
        System.out.println("안녕하세요"); // 문자열 문자 여러개가 나열된 형태를 말하며 쌍따옴표(double-quotation)으로 감싸주어야 한다
        System.out.println("123"); // 정수이지만 큰따옴표로 감싸져있기에 문자열로 보아야한다.
