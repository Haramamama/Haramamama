...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        /* 상수란? // 고정된 값
        * 변수가 메모리에 변경될 값을 저장하기 위한 공간으로 나타난다면. 상수는 이와 상반되는 개념이다.
        ...
        * 3. 필요한 위치에 상수를 호출해서 사용한다. */
        ...
        /*3-2 필요시에는 연산시에 호출하여 사용한다 */
        System.out.println("AGE의 2배 : " + (AGE *2));

        /*3-3 대입연산시 활용 */
        int sum = AGE;  // 대입연산자의 오른쪽에는 기술 가능함.
         // AGE = AGE + 10; // 대입연산자의 왼쪽에는 기술이 불가능함.
