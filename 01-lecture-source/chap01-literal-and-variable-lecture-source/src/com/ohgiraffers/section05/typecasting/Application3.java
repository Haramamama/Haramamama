...
public class Application3 {
    ...
    public static void main (String[] args){
        ...
        /* 수업 목표: 자동형변환과 강제형변환을 이용하여 서로 다른 자료형끼리 연산을 수행할 수 있다. */
        /*
        ...
        * */
        ...
        /*목차3. 결과값을 long으로 받는다. (자동형변환 이용)*/
        long lsum = inum + lnum;

        /* 주의 사항: int미만의 연산 처리의 결과는 int형이다.*/
        byte bnum1 = 1;
        byte bnum2 = 2;
        short snum1 = 3;
        short snum2 = 4;

        //short snum = bnum1 + snum1; :에러 발생-int보다 작은 애들이기 때문에
       //byte b = bnum1 + bnum2 : 에러 발생
