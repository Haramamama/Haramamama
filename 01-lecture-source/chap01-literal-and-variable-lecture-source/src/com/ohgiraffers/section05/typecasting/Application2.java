...
public class Application2 {
    ...
    public static void main (String[] args){
        ...
        *  1-4 논리형은 강제 형변환 규칙에서도 제외된다. */
        ...
        /*  1-1-1 정수 끼리의 강제 형변환*/
        long lnum = 8;
        // int inum = lnum;  // 데이터 손실 가능성을 컴파일러가 알려준다. (에러 남)
        int inum = (int) lnum; // 변경하려는 자료형을 명시해서 강제 형변환을 해야한다. 괄호를 통해.

        short snum = (short) inum; // 바꾸려는 캐스트 자료를 괄호안에 넣어줘야한다. // 이거는 데이터 손실 일어남.
        ...
        /* 1-2 실수를 정수로 변경 시 강제 형변환이 필요하다*/
        float fnum1 = 4.0f;
        // long lnum2 = fnum1; // 소수점 자리 이하의 데이터 손실 가능성으로 자료형의 byte 값이 크더라도 불가능하다.
        long lnum2 = (long) fnum1; // 강제 형변환의 의미는 '내가 데이터 손실을 감안할테니 형변환 해줘' 라는 의미이다.
