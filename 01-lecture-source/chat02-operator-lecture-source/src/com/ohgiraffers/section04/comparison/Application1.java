...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        /*
        * 비교 연산자
        * 비교 연산자는 피연산자 사이에 상대적인 크기를 판단하여 참 혹은 거짓을 변환하는 연산자이다.
        * 연산자 중 참 혹은 거짓을 변환하는 연산자는 심항연산자의 조건식이나 조건문의 조건철에 많이 사용된다
        * (충분히 연습이 필요함!)
        * */

        /*
        * 비교연산자의 종류 // 자바에서는 대입연산자
        ...
        * */
        ...
        System.out.println("inum1이 inum2보다 크거나 같은지 비교 :" + (inum1>=inum2)); // 부호 순서 바꾸면 안됨
        ...
        //System.out.println("bool1이 bool2보다 큰지 비교 :" + (bool1>=bool2)); // 대소비교 불가

        /* 4. 문자열의 값 비교*/
        /* 문자열도 ==과 !=는 비교가 가능하지만 대소비교는 불가능하다. */
        String str1 = "java";
        String str2 = "java"; // 자바는 대소문자를 구분한다.
        ...
        // System.out.println("str1이 str2보다 작은지 비교 :" + (str1<str2)); // 대소 구분이 불가하다.
