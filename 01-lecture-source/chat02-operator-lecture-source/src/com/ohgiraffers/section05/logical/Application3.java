...
public class Application3 {
    ...
    public static void main(String[] args){
        ...
        /*
        * AND 연산과 OR 연산의 특징
        * 논리식 && 논리식 : 앞의 결과가 false이면 뒤의 결과도 자동으로 false이기에 뒤를 실행 안함.
        * 논리식 || 논리식 : 앞의 결과가 true이면 뒤의 결과도 자동으로 true이기에 뒤를 실행 안함.
         * */

        /*1. 논리식 && 논리식 : 앞의 결과가 false이면 뒤를 실행 안함 */
        /*
        * 조건식 두 개가 모두 만족되어야 true를 반환하지만 앞에 미리 false가 나오게 되며ㅣㄴ
        * 뒤에 조건을 확인할 필요없이 false를 반환한다.
        * 따라서 연산 횟수를 줄이기 위해서는 &&연산의 경우 앞에 false가 나올 가능성이 높은 조건을 작성하는 것이 좋다. */

        int num1 = 10;

        int result = (false && ++num1 > 0 )? num1 : num1;  //원래 값은 11이지만 앞에가 false 이기에 뒤 계산 실행 안함.
