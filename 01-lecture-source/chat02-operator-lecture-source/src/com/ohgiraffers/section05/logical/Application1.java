...
public class Application1 {
    ...
    public static void main(String[] args){
        ...
        /*
        * 논리 연산자
        * 논리값 (true or falss) 를 취급하는 연산자이다.
        *
        * 논리연산자의 종류
        ...
        * 1-2. ||논리(OR) 연산자 : 두 개의 논리식 중 둘 중 하나라도 참인 경우 참을 반환 둘 다 거짓일 경우 거짓을 반환하는 연산지이다.
        * 2. 논리 부정 연산자 : 피연산자가 하나인 단항연산자로, 피연산자의 결함 방향은 왼쪽에서 오른쪽이다.
        ...
        * */
        ...
        System.out.println("a가 b보다 작거나 c가 d보다 작크지 확인 : " + (a < b || c > d));
