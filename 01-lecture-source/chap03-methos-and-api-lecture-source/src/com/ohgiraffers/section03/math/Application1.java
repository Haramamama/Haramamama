...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * 쉽게 말해 우리가 구현하기 번거로운 기능들을 JDK를 설치하면 사용할 수 있도록
        ...
        * */
        ...
        System.out.println("20과 30중에 더 큰것은 ? :" + Math.max(10,20));

        System.out.println("원주율 : " + Math.PI);  //코드 네임을 그냥 가져다 쓰기만 하면 된다.

        /* 3. 난수 출력*/
        System.out.println("난수 발생 : " + Math.random());  // 계속해서 실행 시킬수록 값이 다 다르게 나온다.
    }
}
