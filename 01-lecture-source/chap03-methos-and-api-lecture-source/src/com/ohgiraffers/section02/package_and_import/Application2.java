...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 1. non-static method 의 경우*/

        int min = cal.minNumberOf(50,60);

        System.out.println("50과 60중에 더 작은 값은? :" + min);

        /* 2. static method 의 경우*/

        int max = maxNumberOf(50, 60);

        System.out.println("50과 60 중에 더 큰 값은? : " +max);

        /*3. static 메소드를 호출할때 클래스명을 생략하고 사용할 수 있다. */

        int max2 = maxNumberOf(100, 200); // static import 메소드 수동추가

        System.out.println("100과 200 중에 더 큰 값은? " + max2);
    }
}
