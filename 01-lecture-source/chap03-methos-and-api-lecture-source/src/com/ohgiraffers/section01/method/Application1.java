...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *
        * 메소드 사용 목적
        * 1. 중복되는 코드를 메소드로 만들어 코드 반복 사용을 피할 수 있다.
        * 2. 코드의 가독성이 좋아진다.
        * 3. 기능변경이 필요한 경우 메소드 부분만 수정하면 되기 때문에. 손쉬운 유지 보수가 가능하다. */

        System.out.println("main() 시작됨...");

        /* 1. main method 밖에 하단에 methodA 라는 메소드를 추가한다. */
    ...
    public void methodB(){
        ...
        System.out.println("9시 30분에 수업 시작합니다.");

        methodC();

        System.out.println("6시 20분에 수업 끝납니다.");
    }

    public void methodC(){

        System.out.println("점심시간 시작은 1시 20분입니다. ");
