...
public class Application9 {
    ...
    public static void main(String[] args) {
        ...
        * 사용할 이름.메소드명();*/
        ...
        Calculator cal = new Calculator(); // 동일한 패키지에 있기에 선언 가능
        int min = cal.minNumberDf(first,second);
        ...
        * */
        ...
        int max = Calculator.maxNumberDf(first, second);
        ...
        * */
        ...
        int max2 = cal.maxNumberDf(first, second);
