...
public class A_for {
    ...
    public void testSimpleForStatement() {
        ...
        /* 수업 목표: for 단독 사용에 대한 흐름 이해하고 적용할 수 있다. */
        /*
         * [for문 표현식]
         * for(초기식; 조건식; 증감식;) {
        ...
        for (; j <= 15; j++) {   // 증감식을 밑에 빼도 돌아가지만 조건식은 반드시 있어야 한다.
    ...
    public void testForExample1() {
        /* 우리가 뭘 반복하는지 확인하여 반목문으로 개선할 수 있다. */
        ...
        /* 반복횟수는  1~10까지 1씩 증가하여 총 10번을 반복하였다. */
    ...
    public void printSimplegugudan(){
        ...
        /* 수업 목표: 무엇을 반복하는지 확인하여 반복문으로 계산할 수 있다.*/
        /*
        * 키보드로 2~9사이에 구구단을 입력받아
        * 2~9사이의 경우 해당 난의 구구단을 출력하고
        * 그렇지 않은 경우 "반드시 2_9 사이의 양수를 입력해야합니다." 출력
        * */
