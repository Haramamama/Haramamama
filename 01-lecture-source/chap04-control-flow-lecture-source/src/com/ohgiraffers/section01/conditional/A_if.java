...
public class A_if {
    ...
    public void testSimpleIfStatement() {
        ...
        System.out.println("프로그램이 종료합니다. "); // 조건식에 맞지 않기에 나오는 문구.
     ...
     public void testNestedStatement(){
         ...
         * 짝수이면 "입력하신 숫자는 양수이면서 짝수입니다"라고 출력하가ㅗ
         * 둘 중 하나라도 해당하지 않으면 아무 내용도 출력하지 않는 구문을 작성헤보자.
         * 단, 조건과 상관없이 프로그램이 종료할 때 "프로그램을 종료합니다"라고 출력 되도록 한다.
         * */
