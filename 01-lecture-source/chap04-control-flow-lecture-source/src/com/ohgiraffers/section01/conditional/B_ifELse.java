...
public class B_ifELse {
    ...
    public void simpleIfElseStatement() {
        ...
        /* 수업 목표: if-else 단독 사용에 대한 흐름을 이해하고 적용할 수 있다.*/
        /*
         * [if-else 표현식]
         * if(조건식){
        ...
        /* 정수 한 개를 입력받아 그 수가 홀수이면 "입력하신 숫자는 홀수 입니다. 라고 출력하고
    ...
    public void testNeatedIfELseStatement() {
         ...
         * 음수이면 " 입력하신 숫자는 음수입니다 " 를 출력한다.
         * 단, 0이면 0입니다. 라고 출력하세요.
         * 조건과 상관없이 프로그램이 종료될 때는 "프로그램을 종료합니다."라고 출력되도록 한다.*/
        ...
        if (num1 != 0) {
            if (num1 > 0) {
                ...
                System.out.print("입력하신 숫자는 음수입니다.");
            }
