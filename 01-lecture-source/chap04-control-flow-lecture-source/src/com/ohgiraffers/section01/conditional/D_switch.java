...
public class D_switch {
    ...
    /* 수업 목표: switch문 단독 사용에 대한 흐름을 이해하고, 적용할 수 있다. */
    /* [switch문 표현식]
    * switch(비교할 변수){
    *     casa 비교값1 : 비교값1과 일치할 경우 실행할 구문; break;
    *     casa 비교값1 : 비교값2와 일치할 경우 실행할 구문; break;
    ...
    * */
        ...
        char op = sc.next().charAt(0); // sc.nextLine은 불가능.
    ...
    public void testSwitchVendingMachine(){
        ...
        /* 수업 목표: switch문 내에 break문에 대해 흐름을 이해하고 적용할 수 있다.*/
        /* switch문을 이용하여 문자열 값 비교 및 break문 테스트*/
        /*
        * 1. JDK 1.7 이상부터 swiitch문을 사용하여 문자열을 비교할 수 있다.
